          ...
          <View style={styles.DPadInnerCircle}>
            <View style={styles.leftRightView}>
              ...
              <View style={[styles.leftArrowView, 
                            ...
                            this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7.4/414) } : null,
                ...
                <View style={[styles.arrowInsideView, 
                              ...
                              this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' ? { height: Dimensions.get('window').width * (0.42 / 3), borderBottomLeftRadius: 0, borderBottomRightRadius: 0} : null,
                              this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' ? {top: -1 * Dimensions.get('window').width * (8/375) , right: 0,    height: Dimensions.get('window').width * (0.42 / 3.5 + 0.02), width: Dimensions.get('window').width * 0.42 / 3} : null,
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' && Dimensions.get('window').width===320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 + Dimensions.get('window').width * (-0.5/375), height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' && Dimensions.get('window').width!==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 , height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down'  && Dimensions.get('window').width===320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 -  Dimensions.get('window').width * (1/414) + Dimensions.get('window').width * (-0.5/375), height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  width: Dimensions.get('window').width * 0.42 / 3.9, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down'  && Dimensions.get('window').width!==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 -  Dimensions.get('window').width * (1/414) , height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  width: Dimensions.get('window').width * 0.42 / 3.9, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null]}/>
              </View>
              <View style={[styles.rightArrowView, 
                            ...
                            this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' && Dimensions.get('window').width===320 ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7/414)} : null,
                            this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' && Dimensions.get('window').width!==320 ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7.4/414)} : null,
                ...
                <View style={[styles.arrowInsideView, 
                              ...
                              this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' ? { height: Dimensions.get('window').width * (0.42 / 3), borderBottomLeftRadius: 0, borderBottomRightRadius: 0} : null,
                              this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' ? {top: -1 * Dimensions.get('window').width * (8/375) , right: 0, height: Dimensions.get('window').width * (0.42 / 3.5 + 0.02), width: Dimensions.get('window').width * 0.42 / 3} : null,
                              
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' && Dimensions.get('window').width==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 + Dimensions.get('window').width * (-0.1/375), height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' && Dimensions.get('window').width!==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8, height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down' && (Dimensions.get('window').width===375 ||320 ) ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  , width: Dimensions.get('window').width * 0.42 / 3.9, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down' && (Dimensions.get('window').width === 414 )  ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  , width: Dimensions.get('window').width * 0.42 / 3.92, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null]}/>
              </View>
            </View>
            ...
            <View style={styles.upDownView}>
              <View style={[styles.upArrowView, 
                            ...
                            this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7.4/414)} : null,
                ...
                <View style={[styles.arrowInsideView, 
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' ? { height: Dimensions.get('window').width * (0.42 / 3), borderBottomLeftRadius: 0, borderBottomRightRadius: 0} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down' ? {top: -1 * Dimensions.get('window').width * (8/375) , right: 0, height: Dimensions.get('window').width * (0.42 / 3.5 + 0.02), width: Dimensions.get('window').width * 0.42 / 3} : null,
                              this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' && Dimensions.get('window').width==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8  + Dimensions.get('window').width * (-0.5/375), height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' && Dimensions.get('window').width!==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 , height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null]}/>
              </View>
              ...
              <View style={[styles.downArrowView, 
                            ...
                            this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down' ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7.4/414) - 1.3} : null]}>
                ...
                <View style={[styles.arrowInsideView, 
                              !this.props.currentButtonPresses.down && !this.props.currentButtonPresses.left && !this.props.currentButtonPresses.right && !this.props.currentButtonPresses.up ? {top: -1 * Dimensions.get('window').width * (10/375) , right: 0, height: Dimensions.get('window').width * (0.42 / 2.75), width: Dimensions.get('window').width * 0.42 / 3} : null,
                              this.props.currentButtonPresses.down && this.props.latestDPadTouch==='down' ? { right: Dimensions.get('window').width * 0.42 / 5 * 1/8, top: +0, height: Dimensions.get('window').width * (0.42 / 2.9), width: Dimensions.get('window').width * 0.42 / 3.5, borderBottomLeftRadius: 0, borderBottomRightRadius: 0} : null,
                              this.props.currentButtonPresses.up && this.props.latestDPadTouch==='up' ? {top: -1 * Dimensions.get('window').width * (8/375) , right: 0, height: Dimensions.get('window').width * (0.42 / 3.5 + 0.02), width: Dimensions.get('window').width * 0.42 / 3} : null,
                              this.props.currentButtonPresses.left && this.props.latestDPadTouch==='left' ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' && Dimensions.get('window').width===320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8 + Dimensions.get('window').width * (-0.5/375), height: Dimensions.get('window').width * (0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              
                              this.props.currentButtonPresses.right && this.props.latestDPadTouch==='right' && Dimensions.get('window').width!== 320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8, height: Dimensions.get('window').width * (0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null]}/>
              </View>
            </View>
          </View> 
        </View>

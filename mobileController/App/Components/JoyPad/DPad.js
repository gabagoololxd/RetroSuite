          ...
          <View style={styles.DPadInnerCircle}>
            <View style={styles.leftRightView}>
              ...
              <View style={[styles.rightArrowView, 
                ...
                <View style={[styles.arrowInsideView, 
                              ...
                              this.props.currentButtonPresses.up && Dimensions.get('window').width!==320 ? {right: Dimensions.get('window').width * 0.42 / 3 * 1/8, height: Dimensions.get('window').width * (+ 0.42 / 3)  ,  borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && (Dimensions.get('window').width===375 ||320 ) ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  , width: Dimensions.get('window').width * 0.42 / 3.9, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null,
                              this.props.currentButtonPresses.down && (Dimensions.get('window').width === 414 )  ? {height: Dimensions.get('window').width * (+ 0.42 / 3)  , width: Dimensions.get('window').width * 0.42 / 3.92, borderBottomLeftRadius: 0,  borderBottomRightRadius:0, borderBottomWidth: Dimensions.get('window').width * 0.01, borderBottomColor: '#252622'} : null]}/>
              </View>
            </View>
            ...
            <View style={styles.upDownView}>
              ...
              <View style={[styles.downArrowView, 
                            ...
                            this.props.currentButtonPresses.down ? {borderLeftColor: '#252622', borderRightColor: '#252622', height: Dimensions.get('window').width * (0.42 / 3) + Dimensions.get('window').width * (7.4/414) - 1.3} : null]}>
                ...
                <View style={[styles.arrowInsideView, 
                              ...
                              this.props.currentButtonPresses.down ? { right: Dimensions.get('window').width * 0.42 / 5 * 1/8, top: +0, height: Dimensions.get('window').width * (0.42 / 2.9), width: Dimensions.get('window').width * 0.42 / 3.5, borderBottomLeftRadius: 0, borderBottomRightRadius: 0} : null,
